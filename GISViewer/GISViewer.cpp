...
// GISViewer.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CGISViewerApp, CWinApp)
...
CGISViewerApp::CGISViewerApp()
{
	...
	SetAppID(_T("GISViewer.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CGISViewerApp 개체입니다.
